...
- 🔍 **Tap-to-Enlarge Image Lightbox & Original-Size Storage**: Uploaded photos are stored at full original image resolution and quality; tap any photo thumbnail to view full-resolution garment photos with backdrop/Escape dismissal.
...
- 👤 **Personal Profile, Body Type & Complexion Styling**: Upload a portrait/selfie in Settings to analyze skin tone depth (ITA°), warm/cool undertones, body shape silhouettes (Inverted Triangle, Rectangle, Hourglass, Pear, Oval), and personal color season 100% offline, displaying tailored personal fit scorecards for every outfit.
